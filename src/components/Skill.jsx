  ...
  return (
    <div className="bg-snow-200 dark:bg-forest-200 text-snow-400 dark:text-forest-400">
      ...
      <div className="flex flex-wrap md:flex-nowrap justify-center p-5 md:gap-7">
        <p className="md:w-1/2 flex items-center text-md md:text-1xl lg:text-2xl text-center md:text-right font-semibold py-10" style={{ fontFamily: "Montserrat, sans-serif" }}>
          {desc}
        </p>
        <ul className="md:w-1/2 lg:basis-1/3 flex flex-wrap justify-center text-5xl text-snow-300 dark:text-forest-300 gap-10 my-4 md:py-0">
          <li>
            <SiHtml5 />
          </li>
          <li>
