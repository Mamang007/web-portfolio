...
export default function Skill({ dark, desc }) {
  ...
  return (
    <div className="bg-snow-200 dark:bg-forest-200 text-snow-400 dark:text-forest-400">
      ...
      <h1 className="hide text-2xl md:text-3xl lg:text-4xl px-16 font-bold uppercase text-center" style={{ fontFamily: "Lato, sans-serif" }}>
        Introduce My Skill
      </h1>
      <div className="flex flex-wrap md:flex-nowrap justify-center p-5 md:gap-7">
        ...
        <ul className="hide md:w-1/2 lg:basis-1/3 flex flex-wrap justify-center text-5xl text-snow-300 dark:text-forest-300 gap-10 my-4 md:py-0">
          <li>
            <SiHtml5 />
          </li>
          <li>
